package pub.gll.module.algorithm.algorithm._11_哈希表.file;
...
public class Files {
	...
	public static FileInfo read(String dir, String[] extensions) {
		...
		final String[] extensions1 = extensions;
		dirFile.listFiles(new FileFilter() {
			public boolean accept(File subFile) {
				String subFilepath = subFile.getAbsolutePath();
				if (subFile.isDirectory()) {
					info.append(read(subFilepath, extensions1));
				} else if (extensions1 != null && extensions1.length > 0) {
					for (String extension : extensions1) {
