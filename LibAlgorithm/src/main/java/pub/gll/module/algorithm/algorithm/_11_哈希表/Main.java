package pub.gll.module.algorithm.algorithm._11_哈希表;

import java.util.List;

import pub.gll.module.algorithm.algorithm._11_哈希表.Times.Task;
import pub.gll.module.algorithm.algorithm._11_哈希表.file.FileInfo;
import pub.gll.module.algorithm.algorithm._11_哈希表.file.Files;
import pub.gll.module.algorithm.algorithm._11_哈希表.map.HashMap;
import pub.gll.module.algorithm.algorithm._11_哈希表.map.LinkedHashMap;
import pub.gll.module.algorithm.algorithm._11_哈希表.map.Map;
import pub.gll.module.algorithm.algorithm._11_哈希表.map.Map.Visitor;
import pub.gll.module.algorithm.algorithm._11_哈希表.map.TreeMap;
import pub.gll.module.algorithm.algorithm._11_哈希表.model.Key;
import pub.gll.module.algorithm.algorithm._11_哈希表.model.SubKey1;
import pub.gll.module.algorithm.algorithm._11_哈希表.model.SubKey2;

public class Main {

	static void test1Map(Map<String, Integer> map1, String[] words1) {
		final String[] words = words1;
		final Map<String, Integer> map = map1;
